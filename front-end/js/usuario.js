...
document.getElementById("numero_documento_usuario").addEventListener("keypress",soloNumeros);
document.getElementById("nombre_usuario").addEventListener("keypress",soloLetras);
document.getElementById("direccion_usuario").addEventListener("keypress",letrasYNumeros);
document.getElementById("correo_electronico_usuario").addEventListener("keypress",letrasYNumeros);
